...
class Experiment2:
    ...
    def begin_control_loop(self):
        ...
        data_collector.add_to_plot('power_plant_1.pressure_sensor', 'oracle.timer')
        data_collector.add_to_plot('power_plant_1.temperature_sensor', 'oracle.timer')
        data_collector.add_to_plot('power_plant_2.pressure_sensor', 'oracle.timer')
        data_collector.add_to_plot('power_plant_2.temperature_sensor', 'oracle.timer')
...
if __name__ == "__main__":
    ...
    with open(fpath, 'r') as stream:
        try:
            ...
            print(exc)
            exit(1)
    falseActor = Experiment2(config_yaml)
